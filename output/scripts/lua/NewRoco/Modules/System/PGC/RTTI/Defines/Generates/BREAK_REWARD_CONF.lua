...
local BREAK_REWARD_CONF = {
  Name = "BREAK_REWARD_CONF",
  Version = 1,
  Description = "",
  Metadata = {
    Alias = "",
    RelativeYamlPath = "pet/BREAK_REWARD_CONF.yaml",
    SheetIndex = 0,
    NeedPrimaryKey = true
  },
  Fields = {
    ...
    },
    {
      ...
      Constraints = {
        ...
        },
        {
          ...
          TypeName = "BREAK_REWARD_CONF_break_award"
        }
      },
...
RTTIManager:RegisterType(BREAK_REWARD_CONF.Name, BREAK_REWARD_CONF)
